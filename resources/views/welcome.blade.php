...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="alert alert-primary animate__animated animate__bounceInDown">
                    Ganador! 
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati laudantium, est doloribus iure impedit consequuntur ullam perspiciatis nam incidunt illum ipsa, facere doloremque labore adipisci aliquam, vel eveniet quae earum?
                </div>
